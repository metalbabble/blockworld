# BlockWorld — Command Reference

Press `/` during gameplay to open the command bar.

| Command | Description |
|---|---|
| `debug` | Toggle debug mode — 4× speed and hold Space to fly |
| `drawdistance <n>` | Set draw distance to `n` chunks (1–32) |
| `info on` | Show the world-info overlay (XYZ position, chunk, seed) |
| `info off` | Hide the world-info overlay (default) |
